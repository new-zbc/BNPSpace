...
ggsave(box_ARI, filename = "simulation1/ARI_results.png", width = 10, height = 10)
...
###################################################################
###### show the ARI of simulation 2, figure 2
###################################################################
...
ggsave(box_ARI, filename = "simulation/plot/simulation_2_ARI.png", width = 10, height = 5)
